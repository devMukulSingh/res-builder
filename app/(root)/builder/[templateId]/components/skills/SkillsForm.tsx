...
const SkillsForm = () => {
  ...
  const customSkills = useAppSelector(
    (state) => state.persistedReducer.technicalSkills?.customSkills,
  );
  const aiSuggestedSkills = useAppSelector(
    (state) => state.persistedReducer.aiSuggestedSkills,
  );
